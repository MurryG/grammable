...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#update action" do
    ...
    it "should render the edit form with an http status of unprocessable_entity if validation errors exist" do
      gram = FactoryBot.create(:gram, message: "Initial Value")
      sign_in gram.user
  ...
  describe "grams#new action" do
    it "should require the users to be logged in" do
      get :new
      expect(response).to redirect_to new_user_session_path
    end
  ...
  describe "grams#create action" do
    ...
    it "should properly deal with validation errors" do
      ...
      og_gram_count = Gram.count
      post :create, params: { gram: { message: '' } }
      expect(response).to have_http_status(:unprocessable_entity)
      expect(og_gram_count).to eq Gram.count
    end
  end
end
